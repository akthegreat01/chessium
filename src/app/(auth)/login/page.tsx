  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <button
        type="button"
        disabled
        className="w-full h-11 bg-surface border border-border rounded-2xl text-[14px] font-medium text-secondary-foreground hover:text-foreground hover:bg-surface transition-all duration-200 flex items-center justify-center gap-2.5 cursor-not-allowed opacity-50"
      >
