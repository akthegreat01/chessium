...
const adventureNavItems: NavItem[] = [];
...
const communityNavItems: NavItem[] = [
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 18.97a5.969 5.969 0 01-.749-2.553C3.62 15.352 3 13.748 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
      </svg>
    ),
  },
  {
        ...
        {(() => {
          ...
          return (
            <>
              ...
              {adventureNavItems.length > 0 && (
                <>
                  <div className="my-6 h-px w-full bg-gradient-to-r from-transparent via-[#2a2a30] to-transparent" />
                  {!isCollapsed && <p className="mb-3 px-3 text-[11px] font-bold uppercase tracking-[0.15em] text-[#505058]">Adventure</p>}
                  {adventureNavItems.map(renderItem)}
                </>
              )}
