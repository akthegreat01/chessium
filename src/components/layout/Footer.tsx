...
const socialLinks = [
  {
    label: 'Twitter',
    href: 'https://twitter.com/chessium',
    icon: (
  ...
  {
    label: 'Discord',
    href: 'https://discord.gg/chessium',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/chessium',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@chessium',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-6 flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="rounded-lg border border-border p-2 text-text-tertiary transition-all hover:border-border-hover hover:text-text-secondary hover:bg-white/5"
