...
// Inline SVG knight path (same as Header)
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              {/* Gold Knight Logo - Larger and more prominent */}
              <div style={{
                width: '52px',
                height: '52px',
                borderRadius: '16px',
                ...
                <svg viewBox="0 0 45 45" width="36" height="36" style={{ filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.3))' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
              ...
              <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, marginTop: '2px' }}>WHITE</span>
            </div>
            <div style={{
              padding: '8px 18px',
              ...
              <span style={{ fontSize: '22px', fontWeight: 950, color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
                {result}
              </span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
              ...
              <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, marginTop: '2px' }}>BLACK</span>
            </div>
          </div>
            ...
            <div style={{ position: 'relative', width: '160px', height: '160px' }}>
              <svg width="160" height="160" style={{ transform: 'rotate(-90deg)' }}>
                ...
                <circle
                  ...
                  strokeLinecap="round"
                  style={{ filter: `drop-shadow(0 0 12px ${accColor}40)` }}
                />
              </svg>
              <div style={{
                position: 'absolute',
                ...
                <span style={{ fontSize: '48px', fontWeight: 950, color: '#fff', lineHeight: 1, fontFamily: 'system-ui, sans-serif' }}>
                  {avgAccuracy}%
                </span>
                <span style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.25em', marginTop: '6px' }}>
                  Accuracy
                </span>
              </div>
            </div>
            ...
            {stats.map((stat) => (
              <div key={stat.label} style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <span style={{ fontSize: '9px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
                    {stat.label}
                  </span>
        ...
        <div className="flex gap-3">
          <button 
            ...
            disabled={loading}
            className="flex-1 h-14 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95 disabled:opacity-50"
            style={{
          ...
          >
            {loading ? <div className="w-5 h-5 border-2 border-black/20 border-t-black rounded-full animate-spin" /> : 'Save Card'}
          </button>
          <button 
            onClick={onClose}
            className="w-14 h-14 bg-white/10 hover:bg-white/20 rounded-2xl flex items-center justify-center border border-white/10 transition-all active:scale-95"
          >
